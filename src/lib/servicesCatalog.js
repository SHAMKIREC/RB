...
// Старые подкатегории уже имеют свои изображения. Здесь задаём изображения только
// новым подпунктам Рамиля, которые раньше получали одну и ту же картинку категории.
const RAMIL_SUBCATEGORY_IMAGES = {
  ...
  turnkey_capital: 'https://images.unsplash.com/photo-1503387762-592deb58ef4e?w=1200&q=82',
