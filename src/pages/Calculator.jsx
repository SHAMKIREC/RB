...
export default function Calculator() {
  ...
  useEffect(() => { localStorage.setItem(DRAFT_KEY, JSON.stringify({ quantities, turnkeyTotal, materialSelections })); }, [quantities, turnkeyTotal, materialSelections]);
