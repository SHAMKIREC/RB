...
export default function Projects() {
  ...
  useEffect(() => {
    const refresh = async () => {
      try { setProjects(await getPublishedProjects()); setLoadError(false); }
