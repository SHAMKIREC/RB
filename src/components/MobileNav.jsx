...
export default function MobileNav() {
  return <nav aria-label="Быстрая связь" className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl xl:hidden"><div className="mx-auto grid w-full max-w-xl grid-cols-5 gap-2 px-3 py-2.5">{contacts.map(({ label, href, Icon }) => {
