...
export default function MobileNav() {
  return <>
    <nav aria-label="Быстрая связь" className="fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/95 pb-[env(safe-area-inset-bottom)] backdrop-blur-xl lg:hidden">
