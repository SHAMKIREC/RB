    ...
    <section className="page-shell py-8 sm:py-10">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        {PREVIEW_SERVICES.map((service) => (
          <article key={service.id} className="rb-card group flex h-full flex-col rounded-3xl border-2 border-primary/70 bg-card p-5 shadow-[0_16px_36px_-26px_rgba(15,23,42,0.34),0_5px_14px_-11px_rgba(234,88,12,0.18)] transition-all duration-200 ease-out hover:-translate-y-1 hover:border-primary hover:shadow-[0_22px_44px_-26px_rgba(15,23,42,0.42),0_10px_20px_-14px_rgba(234,88,12,0.28)]">
